...
public struct MarkdownContent: Equatable, MarkdownContentProtocol {
  ...
  /// The block elements that form this Markdown content.
  ///
  /// You can use this property to inspect, filter, or modify the block structure
  ...
  /// let filtered = blocks.filter { !$0.isParagraph }
  /// let newContent = MarkdownContent(blocks: filtered)
  /// ```
  public let blocks: [BlockNode]

  /// Creates Markdown content from an array of block elements.
  ///
  /// Use this initializer to construct Markdown content from blocks you've
  /// created or modified programmatically.
  ///
  /// - Parameter blocks: The block elements to include in the content.
  public init(blocks: [BlockNode] = []) {
    self.blocks = blocks
  }

  /// Creates Markdown content from a single block element.
  ///
  /// - Parameter block: The block element to include in the content.
